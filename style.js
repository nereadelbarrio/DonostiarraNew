...
(function (blink) {
	...
	donostiarraNewStyle.prototype = {
		...
		formatCarouselindicators: function () {
			this.parent.formatCarouselindicators.call(this.parent, this, 'donostiarraNew-navbar');
		},
		...
		animateNavbarOnScroll: function () {
			this.parent.animateNavbarOnScroll.call(this.parent, this, 'donostiarraNew-navbar');
		},
	...
	donostiarraNewStyle.prototype = _.extend({}, new blink.theme.styles.mcgrawhill(), donostiarraNewStyle.prototype);
