...
{ name: 'Título Intro', element: 'h2', attributes: { 'class': 'bck-title-intro'} },
				...
				{ name: 'Énfasis IndieFlower', element: 'span', attributes: { 'class': 'bck-enfasis-12'} },
				...
				{ name: 'Lista des 4 verde', element: 'ul', attributes: { 'class': 'bck-ul-4'} },
				{ name: 'Lista des 5 rosa', element: 'ul', attributes: { 'class': 'bck-ul-5'} },
